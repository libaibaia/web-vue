            ...
            <el-col class="lg-mb-20" :xs="24" :sm="24" :md="24" :lg="10">
                <div class="admin-info">
                    ...
                    <div class="admin-info-base">
                        <div class="admin-nike">{{ state.adminInfo.nike }}</div>
                    ...
                    <div class="admin-info-form">
                        ...
                        >
                            ...
                            <el-form-item :label="t('routine.adminInfo.User nike')" prop="nike">
                                <el-input :placeholder="t('routine.adminInfo.Please enter a nike')" v-model="state.adminInfo.nike"></el-input>
                            </el-form-item>
...
const rules: Partial<Record<string, FormItemRule[]>> = reactive({
    nike: [buildValidatorData({ name: 'required', title: t('routine.adminInfo.User nike') })],
...
const onSubmit = (formEl: InstanceType<typeof ElForm> | undefined) => {
    ...
    formEl.validate((valid) => {
        if (valid) {
            ...
            postData(data)
                .then(() => {
                    adminInfoStore.dataFill({ ...adminInfoStore.$state, nike: state.adminInfo.nike })
