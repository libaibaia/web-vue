...
// Admin模块
export const adminUploadUrl = '/api/bucket/file/upload'
export const adminBuildSuffixSvgUrl = '/admin/ajax/buildSuffixSvg'
export const adminAreaUrl = '/api/bucket/file/upload'
...
// api模块(前台)
export const apiUploadUrl = '/api/bucket/file/upload'
...
export class baTableApi {
    ...
    constructor(controllerUrl: string) {
        ...
        this.actionUrl = new Map([
            ['index', controllerUrl + "lists"],
            ['add', controllerUrl + 'add'],
            ['edit', controllerUrl + 'update'],
            ['del', controllerUrl + 'del'],
            ['sortable', controllerUrl + 'sortable'],
            ['stopTask', controllerUrl + 'stop'],
            ['start', controllerUrl + 'start'],
        ])
    }
    stopAllTask() {
        return createAxios({
            url: this.actionUrl.get('stopTask'),
            method: 'get',
        })
    }
    start() {
        return createAxios({
            url: this.actionUrl.get('start'),
            method: 'get',
        })
    }
