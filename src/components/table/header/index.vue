<template>
    ...
    <div v-bind="$attrs" class="table-header ba-scroll-style">
        ...
        <el-tooltip v-if="props.buttons.includes('add')" :content="t('add')" placement="top">
        ...
        <el-tooltip v-if="props.buttons.includes('edit') " :content="t('Edit selected row')" placement="top">
        ...
        <el-tooltip v-if="props.buttons.includes('stopAllTask')" content="停止所有执行中的任务" placement="top">
            <el-button v-blur @click="onAction('stopAllTask')" class="table-header-operate" type="primary">
                <Icon name="fa fa-power-off" />
                <span class="table-header-operate-text">停止所有任务</span>
            </el-button>
        </el-tooltip>
        <el-tooltip v-if="props.buttons.includes('start')" content="重新执行资产扫描" placement="top">
            <el-button v-blur @click="onAction('startAll')" class="table-header-operate" type="primary">
