...
export default class baTable {
    ...
    stopAllTask = ()=>{
        this.api.stopAllTask().then((res) => {
        });

    }
    startAll = ()=>{
        this.api.start().then((res) => {
    ...
    getIndex = () => {
        ...
        return this.api
            ...
            .then((res) => {
                if (res.lists != null) this.table.data = res.lists
                if (res.cosList != null) this.table.data = res.cosList
